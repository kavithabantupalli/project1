...
app.config["MAIL_USERNAME"] = "mahika7396@gmail.com"
app.config["MAIL_PASSWORD"] = "tpan nwcn danx xfoh"
mail = Mail(app)
...
def calculator():
    if isLoggedIn == True:
        if request.method == "POST":
            ...
            msg = Message(subject="calculation", sender="mahika7396@gmail.com",
                        recipients=["a81449021@gmail.com","ishadev2000@gmail.com","mahika7396@gmail.com"]
                        )
